...
get "/kanji/:id", KanjiController::Show

get "/cards", CardController::Index
get "/cards.json", CardController::Download
get "/cards.tsv", CardController::Download
...
get "/quiz", QuizController::Get
post "/quiz", QuizController::Submit
